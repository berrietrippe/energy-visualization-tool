...
class LineGraph {
    constructor(id, title, data, selectors, topics, xAxisId){
        ...
        this.id = id;
        if (selectors == null){
            this.possibleSelectors = getUniqueSelectors(this.data, ["Energy Carriers"]);
        } else {
